...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r border-gray-200 bg-surface">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="px-4">Meniu Principal</SidebarGroupLabel>
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 px-2 py-2.5 rounded-lg transition-all duration-200 ${
                          isActive
                            ? 'bg-indigo-100 text-indigo-700 font-semibold border-l-4 border-indigo-600 pl-1.5'
      ...
      <SidebarFooter className="border-t border-gray-200 px-4 py-3 space-y-2">
