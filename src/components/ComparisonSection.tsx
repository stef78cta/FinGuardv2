...
const ComparisonSection = () => {
  ...
  return <section ref={sectionRef} className="section-padding-reduced bg-gradient-to-b from-surface to-white">
      <div className="container-narrow">
        ...
        <div className={`bg-white rounded-2xl shadow-large border border-gray-100 overflow-hidden transform transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {comparisonData.map((row, index) => <tr key={index} className={`border-b border-gray-50 hover:bg-gray-25 transition-colors duration-200 ${index % 2 === 0 ? 'bg-gray-25/50' : 'bg-white'}`}>
        ...
        <div className="mt-16 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 rounded-3xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {/* Benefit Card 1 */}
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 transform" style={{
            animationDelay: '0ms'
          }}>
