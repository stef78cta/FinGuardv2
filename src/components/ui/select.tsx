...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-[var(--newa-text-muted)]" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ...
    className={cn(
      "py-1.5 pl-8 pr-2",
      "text-xs font-semibold text-[var(--newa-text-muted)]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-sm text-[var(--newa-text-primary)]",
      "outline-none",
      "focus:bg-[var(--newa-state-hover)]",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-[var(--newa-disabled-opacity)]",
      className
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-[var(--newa-brand-accent-indigo)]" />
      </SelectPrimitive.ItemIndicator>
    </span>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-[var(--newa-border-default)]", className)}
    {...props}
  />
));
