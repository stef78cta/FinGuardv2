-- ============================================================================
-- Fix: versionare la re-import / regenerare situații financiare
-- Evită violarea ux_fs_period_type_version când există deja v1 pentru perioadă.
-- ============================================================================
...
BEGIN
    ...
    -- Versiune nouă pentru aceeași perioadă (păstrează istoricul importurilor anterioare)
